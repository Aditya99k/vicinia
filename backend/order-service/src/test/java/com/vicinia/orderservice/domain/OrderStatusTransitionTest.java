...
class OrderStatusTransitionTest {
    ...
    private static final java.util.Map<OrderStatus, Set<OrderStatus>> LEGAL = java.util.Map.ofEntries(
            ...
            java.util.Map.entry(OrderStatus.READY_FOR_PICKUP, EnumSet.of(OrderStatus.DELIVERY_ASSIGNED)),
            java.util.Map.entry(OrderStatus.DELIVERY_ASSIGNED, EnumSet.of(OrderStatus.OUT_FOR_DELIVERY)),
