 ...
 * safe. /product/{productId} is the one public, unauthenticated read here
 * (api-gateway's public-paths), matching the customer-browsing pattern
 * catalog-service's /products/search and /categories already established.
 */
@RestController
