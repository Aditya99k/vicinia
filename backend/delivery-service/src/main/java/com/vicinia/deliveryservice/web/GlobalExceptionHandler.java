...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handlePartnerNotFound(RuntimeException e) {
        return body(HttpStatus.NOT_FOUND, e.getMessage());
    }

    @ExceptionHandler(DeliveryTaskNotFoundException.class)
    public ResponseEntity<Map<String, Object>> handleTaskNotFound(RuntimeException e) {
        return body(HttpStatus.NOT_FOUND, e.getMessage());
    }
    ...
    @ExceptionHandler(IllegalDeliveryTaskStatusException.class)
